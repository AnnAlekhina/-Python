...
def create_tech():
    ...
    dict_dop_param = {1:'Введите тип принтера: ',2: 'Введите разрешение сканера: ',3:'Введите скорость копирования сканера: ' }
    ...
    try:
        ...
        print(f'Вводимые данные должны быть числом!{err} установлено дефолтное значение раное 1 ')
